...
namespace BuurtApplicatie.Migrations
{
    ...
    [Migration("20210123104524_AnonymousTables")]
    partial class AnonymousTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.AnonymousImage", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.ToTable("AnonImages");
                });

            modelBuilder.Entity("BuurtApplicatie.Models.AnonymousPost", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.AnonymousUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.AnonymousImage", b =>
                {
                    b.HasOne("BuurtApplicatie.Models.AnonymousPost", "Post")
                        .WithOne()
                        .HasForeignKey("BuurtApplicatie.Models.AnonymousImage", "PostId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("BuurtApplicatie.Models.AnonymousPost", b =>
                {
                    b.HasOne("BuurtApplicatie.Models.AnonymousUser", "AnonUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.AnonymousUser", b =>
                {
                    b.HasOne("BuurtApplicatie.Areas.Identity.Data.BuurtApplicatieUser", "User")
                        .WithOne()
                        .HasForeignKey("BuurtApplicatie.Models.AnonymousUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
