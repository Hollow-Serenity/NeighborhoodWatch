...
namespace BuurtApplicatie.Migrations
{
    ...
    [Migration("20210119145502_cascadeDeleteDeletedPosts")]
    partial class cascadeDeleteDeletedPosts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.ReportedComment", b =>
                {
                    ...
                    b.HasKey("CommentId", "ReportedById");
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.UserCommentLike", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.UserLoginEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.PostComment", b =>
                {
                    b.HasBaseType("BuurtApplicatie.Models.Comment");
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.ReportedComment", b =>
                {
                    b.HasOne("BuurtApplicatie.Models.Comment", "Comment")
            ...
            modelBuilder.Entity("BuurtApplicatie.Models.UserCommentLike", b =>
                {
                    b.HasOne("BuurtApplicatie.Models.PostComment", "PostComment")
